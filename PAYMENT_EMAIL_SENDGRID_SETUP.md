...
2. Razorpay sends webhook → /api/payments/razorpay/webhook
...
4. If payment successful (payment.captured):
   ...
   ├─ Send email to admins (notification)
...
- ✅ Complete invoice details (Order ID, Payment ID, Amount)
- ✅ PDF invoice attachment
- ✅ Responsive mobile-friendly layout
- ✅ Course/program name included
...
3. **Check logs:**
   ...
   [razorpay:webhook] ✅ Payment confirmation email sent via SendGrid
   ```
...
- ✅ Email failures don't expose sensitive data
- ✅ Non-blocking: payment processing completes even if email fails
...
```bash
# Successful email
✅ Payment confirmation email sent via SendGrid
...
- ✅ Send payment confirmation emails via SendGrid
- ✅ Attach PDF invoices to emails
- ✅ Notify admins of new payments
- ✅ Handle email failures gracefully
- ✅ Work in both development and production

**Test it:** `npm run test:email` 🚀
