...
import { getCourseSchema, getWebPageSchema, getBreadcrumbSchema, renderJsonLd } from "@/lib/schema";
...
const cityData: Record<string, {
  ...
  "bangalore": {
    ...
    examCenters: ["BMS College of Architecture", "MS Ramaiah", "PES University"]
  },
  "mysore": {
    name: "Mysore",
    state: "Karnataka",
  ...
  "dubai": {
    ...
    famousFor: "Home to large Indian community, especially Malayali & Tamil students",
  },
  "abu-dhabi": {
    name: "Abu Dhabi",
    state: "UAE",
...
export default async function CityCoachingPage({ params }: { params: Promise<{ city: string }> }) {
  const { city: citySlug } = await params;
  const city = citySlug.toLowerCase();
  const cityInfo = cityData[city];
  ...
  const isGulfCountry = ["UAE", "Qatar", "Oman", "Saudi Arabia", "Kuwait", "Bahrain"].includes(cityInfo.state);
      ...
      >
        <Container maxWidth="lg">
          ...
          >
            ...
            <Typography
              variant="h6"
              sx={{ color: "text.secondary", mb: 3, fontSize: { xs: "1rem", sm: "1.25rem" } }}
            >
              Online Classes Designed for Busy School Students in {cityInfo.region}
            </Typography>
            <Box sx={{ display: "flex", gap: 2, flexWrap: "wrap" }}>
              <Link href="/auth/login" style={{ textDecoration: "none" }}>
                <Button
                  ...
                  size="large"
                  sx={{
                    backgroundImage: "linear-gradient(45deg, #2b2d4e 30%, #e1148b 90%)",
                    px: 4,
                    py: 1.5,
                    fontSize: "1.1rem",
                    borderRadius: 999,
          ...
          {isGulfCountry && (
            <Paper elevation={2} sx={{ p: { xs: 3, sm: 4 }, mb: 4, borderRadius: 3, background: "linear-gradient(135deg, #fff5f5 0%, #fff 100%)", border: "2px solid #e1148b" }}>
              <Typography variant="h4" sx={{ fontWeight: 600, mb: 3, color: "#2b2d4e" }}>
                🌍 Online NATA Coaching for Indian Students in {cityInfo.name}, {cityInfo.state}
              </Typography>
                  ...
                  <Box sx={{ display: "flex", gap: 2, mb: 2 }}>
                    ...
                    <Box>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        Live interactive classes scheduled to match UAE/Gulf time zones. Perfect for students attending international schools in Dubai, Abu Dhabi, Sharjah, Doha, Muscat & other Gulf cities.
                      </Typography>
                    </Box>
                  </Box>
                </Grid>
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <Box sx={{ display: "flex", gap: 2, mb: 2 }}>
                    ...
                    <Box>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        Learn from Indian Institute of Technology and National Institute of Technology graduate architects with proven track records of training successful NATA & JEE B.Arch students.
                      </Typography>
                    </Box>
                  </Box>
                </Grid>
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <Box sx={{ display: "flex", gap: 2, mb: 2 }}>
                    ...
                    <Box>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        Pay in Indian Rupees at affordable rates - significantly more economical than Gulf-based coaching institutes, while maintaining premium quality education.
                      </Typography>
                    </Box>
                  </Box>
                </Grid>
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <Box sx={{ display: "flex", gap: 2, mb: 2 }}>
                    ...
                    <Box>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        Digital study materials, previous year question papers, mock tests, drawing practice sheets, and weekly performance reports - all accessible from anywhere in the world.
                      </Typography>
                    </Box>
                  </Box>
                </Grid>
              ...
              <Box sx={{ p: 3, bgcolor: "#fff", borderRadius: 2, border: "1px solid #e0e0e0" }}>
                ...
                <Typography component="div" variant="body2" sx={{ lineHeight: 2 }}>
                  ✔ Malayalam & Tamil speaking students in Gulf countries<br />
                  ✔ Students planning to return to India for B.Arch admission<br />
                  ✔ Families in Dubai, Sharjah, Abu Dhabi, Doha, Muscat, Riyadh, Jeddah, Kuwait & Bahrain<br />
                  ✔ Students who prefer learning from India-based expert faculty<br />
                  ✔ Those seeking consistent daily practice with WhatsApp doubt support
                </Typography>
              </Box>
            </Paper>
          )}
          ...
          <Paper elevation={2} sx={{ p: { xs: 3, sm: 4 }, mb: 4, borderRadius: 3 }}>
            <Typography variant="h4" sx={{ fontWeight: 600, mb: 3 }}>
              Why Online NATA & JEE B.Arch Coaching is Perfect for {cityInfo.name} Students
            </Typography>
              ...
              <Grid size={{ xs: 12, md: 6 }}>
                <Box sx={{ display: "flex", gap: 2, mb: 2 }}>
                  ...
                  <Box>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      No travel time means more time for self-study, rest, and other activities. Students can join classes right from home within minutes after school.
                    </Typography>
                  </Box>
                </Box>
              </Grid>
              ...
              <Grid size={{ xs: 12, md: 6 }}>
                <Box sx={{ display: "flex", gap: 2, mb: 2 }}>
                  ...
                  <Box>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      30-60 minute focused sessions every day. No gaps in learning due to traffic, weather, or health concerns. Consistent practice leads to better results.
                    </Typography>
                  </Box>
                </Box>
              </Grid>
              ...
              <Grid size={{ xs: 12, md: 6 }}>
                <Box sx={{ display: "flex", gap: 2, mb: 2 }}>
                  ...
                  <Box>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Perfect for 11th & 12th students who need to maintain their board exam preparation alongside NATA/JEE B.Arch prep. Flexible timing that adapts to your school schedule.
                    </Typography>
                  </Box>
                </Box>
              </Grid>
              ...
              <Grid size={{ xs: 12, md: 6 }}>
                <Box sx={{ display: "flex", gap: 2, mb: 2 }}>
                  ...
                  <Box>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      With regular online classes, there are no breaks or interruptions. Every topic is covered systematically without rushing through the syllabus.
                    </Typography>
                  </Box>
                </Box>
              </Grid>
          ...
          <Paper elevation={2} sx={{ p: { xs: 3, sm: 4 }, mb: 4, borderRadius: 3 }}>
            ...
            <Typography variant="body1" sx={{ mb: 2 }}>
              {cityInfo.name}, located in {cityInfo.state}, is known as the {cityInfo.region}.
              The city is famous for {cityInfo.famousFor}.
            </Typography>
            <Typography variant="body1">
              Students from {cityInfo.name} have traditionally excelled in architecture entrance exams.
              With Neram Classes online coaching, you can continue this legacy while studying conveniently from home,
              saving precious time that would otherwise be spent in traffic or commuting to coaching centers.
            </Typography>
          </Paper>
          ...
          >
            ...
            <Typography variant="h6" sx={{ mb: 3, opacity: 0.9 }}>
              Join 1000+ students from {cityInfo.name} who are preparing with Neram Classes
            </Typography>
            <Box sx={{ display: "flex", gap: 2, justifyContent: "center", flexWrap: "wrap" }}>
              ...
              <Link href="/nata-cutoff-calculator" style={{ textDecoration: "none" }}>
                <Button
                  variant="outlined"
                  size="large"
                  sx={{
