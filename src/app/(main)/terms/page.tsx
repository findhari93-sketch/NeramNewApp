        ...
        <Box sx={{ "& > *": { mb: 3 } }}>
          ...
          <section>
            ...
            <Typography variant="body1" paragraph>
              ...
              Sign-In. Phone verification may be required for certain features.
            </Typography>
          </section>
          ...
          <section>
            ...
            <Typography variant="body1" paragraph>
              <strong>3.1 License:</strong> Subject to these Terms, we grant you
          ...
          <section>
            ...
            <Typography variant="body1" paragraph>
              ...
              license, create derivative works from, or sell any content without
              our prior written consent.
            </Typography>
            <Typography variant="body1" paragraph>
              <strong>4.3 Free Access:</strong> Some materials may be provided
              free of charge. Free access does not grant any ownership rights to
              the content.
            </Typography>
          </section>
          ...
          <section>
            ...
            <Typography variant="body1" paragraph>
              <strong>5.1 Pricing:</strong> Prices for paid courses and services
              are displayed in Indian Rupees (INR) and are subject to change
              without notice.
            </Typography>
            <Typography variant="body1" paragraph>
          ...
          <section>
            ...
            <Typography variant="body1" paragraph>
              You agree to interact respectfully with other users and instructors.
              We reserve the right to remove content or suspend accounts that
              violate our community guidelines, including but not limited to:
            </Typography>
            <Box component="ul" sx={{ pl: 4, mb: 2 }}>
              <li>
                <Typography variant="body1">
          ...
          <section>
            ...
            <Typography variant="body1" paragraph>
              <strong>7.1 Our Rights:</strong> All rights, title, and interest in
              and to the Services, including all intellectual property rights,
              are and will remain the exclusive property of Neram Classes and our
              licensors.
            </Typography>
            <Typography variant="body1" paragraph>
          ...
          <section>
            ...
            <Typography variant="body1" paragraph>
              ...
              security measures to protect your account and personal information.
            </Typography>
            <Typography variant="body1" paragraph>
              <strong>9.2 reCAPTCHA Protection:</strong> This site is protected
          ...
          <section>
            ...
            <Typography variant="body1" paragraph>
              <strong>10.2 No Guarantee of Results:</strong> While we strive to
              provide high-quality educational content, we do not guarantee any
              specific results, exam scores, or outcomes from using our Services.
            </Typography>
            <Typography variant="body1" paragraph>
              <strong>10.3 Limitation of Liability:</strong> TO THE MAXIMUM
              EXTENT PERMITTED BY LAW, NERAM CLASSES SHALL NOT BE LIABLE FOR ANY
              INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES,
              OR ANY LOSS OF PROFITS OR REVENUES.
            </Typography>
            <Typography variant="body1" paragraph>
              <strong>10.4 Third-Party Content:</strong> We are not responsible
              for any third-party content, websites, or services linked from our
              platform.
            </Typography>
          </section>
          ...
          <section>
            ...
            <Typography variant="body1" paragraph>
              ...
              Services. We may experience downtime for maintenance or technical
              issues.
            </Typography>
            <Typography variant="body1" paragraph>
          ...
          <section>
            ...
            <Typography variant="body1" paragraph>
              <strong>14.1 Governing Law:</strong> These Terms shall be governed
              by and construed in accordance with the laws of India, without
              regard to its conflict of law provisions.
            </Typography>
            <Typography variant="body1" paragraph>
              <strong>14.2 Jurisdiction:</strong> Any disputes arising out of or
              relating to these Terms or the Services shall be subject to the
              exclusive jurisdiction of the courts located in [Your City, State],
              India.
            </Typography>
            <Typography variant="body1" paragraph>
              <strong>14.3 Dispute Resolution:</strong> Before filing any formal
              legal action, you agree to attempt to resolve any dispute
          ...
          <section>
            ...
            <Box sx={{ pl: 2 }}>
              ...
              <Typography variant="body1">Email: support@neramclasses.com</Typography>
              <Typography variant="body1">Legal: legal@neramclasses.com</Typography>
              <Typography variant="body1" paragraph>
          ...
          <section>
            ...
            <Typography variant="body1" paragraph>
              <strong>17.1 Entire Agreement:</strong> These Terms constitute the
              entire agreement between you and Neram Classes regarding your use
              of the Services.
            </Typography>
            <Typography variant="body1" paragraph>
              <strong>17.2 Severability:</strong> If any provision of these Terms
              is found to be invalid or unenforceable, the remaining provisions
              will remain in full force and effect.
            </Typography>
            <Typography variant="body1" paragraph>
              <strong>17.3 Waiver:</strong> Our failure to enforce any right or
