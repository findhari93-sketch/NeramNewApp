          ...
          <Box sx={{ "& > *": { mb: 3 } }}>
            ...
            <section>
              ...
              <Typography variant="body1" paragraph>
                ...
                use our educational platform, website, mobile applications, and
            ...
            <section>
              ...
              <Box component="ul" sx={{ pl: 4, mb: 2 }}>
                <li>
                  <Typography variant="body1">
                    <strong>Usage Data:</strong> Pages visited, courses
                    accessed, time spent, features used, and interaction
                    patterns
                  </Typography>
                </li>
                <li>
              ...
              <Box component="ul" sx={{ pl: 4, mb: 2 }}>
                <li>
                  <Typography variant="body1">
                    <strong>Social Media Authentication:</strong> When you sign
                    in using Google or other social media accounts, we receive
                ...
                <li>
                  <Typography variant="body1">
                    ...
                    for authentication services, which may collect
                    authentication tokens and related security information
                  </Typography>
                </li>
                <li>
                  <Typography variant="body1">
                    <strong>Payment Processors:</strong> Payment confirmation
                    and transaction details from our payment partners
                  </Typography>
                </li>
              </Box>
            </section>
              ...
              <Box component="ul" sx={{ pl: 4, mb: 2 }}>
                ...
                <li>
                  <Typography variant="body1">
                    ...
                    patterns, monitor platform performance, identify issues, and
            ...
            <section>
              ...
              <Typography variant="body1" paragraph>
                <strong>4.2 reCAPTCHA Protection:</strong> This site is
            ...
            <section>
              ...
              <Typography variant="body1" paragraph>
                ...
                securely on servers provided by our hosting and database
                partners, including Firebase (Google Cloud Platform) and
                Supabase.
              </Typography>
              <Typography variant="body1" paragraph>
              ...
              <Typography variant="body1" paragraph>
                <strong>6.3 Account Deletion:</strong> If you delete your
              ...
              <Typography variant="body1" paragraph>
                ...
                Backup data is subject to the same privacy protections as live
                data.
              </Typography>
            </section>
            ...
            <section>
              ...
              <Typography variant="body1" paragraph>
                ...
                files stored on your device that help us recognize you and
              ...
              <Box component="ul" sx={{ pl: 4, mb: 2 }}>
                <li>
                  <Typography variant="body1">
                    ...
                    platform to function (authentication, security)
                  </Typography>
                </li>
                <li>
                  <Typography variant="body1">
            ...
            <section>
              ...
              <Typography variant="body1" paragraph>
                ...
                privacy@neramclasses.com. We will respond to your request within
            ...
            <section>
              ...
              <Typography variant="body1" paragraph>
                ...
                for users aged 13 and above. We do not knowingly collect
              ...
              <Typography variant="body1" paragraph>
                <strong>9.3 Notification:</strong> If we become aware that we
            ...
            <section>
              ...
              <Typography variant="body1" paragraph>
                <strong>10.1 Third-Party Links:</strong> Our Services may
                contain links to third-party websites, applications, or
            ...
            <section>
              ...
              <Typography variant="body1" paragraph>
                ...
                processing. You also have the right to lodge a complaint with a
