...
export function shouldRedirect(pathname: string): {
  ...
  const redirectMap: Record<string, string> = {
    ...
    "/NATA-coaching-centers-nearby/Free-NATA-study-Materials.html": "/freebooks",
    "/NATA_Coaching_center_near_me_address/Free-NATA-study-Materials.html": "/freebooks",
    ...
    // === Deep nested paths ===
    "/members/user/activity/course/assets/img/whatsapp/2021/Free-NATA-study-Materials.html": "/freebooks",
